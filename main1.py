...
st.set_page_config(page_title="Youtube Data Harvesting and Warehousing", page_icon=":alien:", layout="wide",
...
if submit1:
    ...
    with st.spinner('Please wait '):
        ...
        def get_channel_details(user_input):
            ...
            data = {"_id": 0, "channel_id": 1, "channel_name": 1, "channel_views": 1, "subscriber_count": 1,
                    "total_videos": 1, "playlist_id": 1}
        ...
        def get_video_details(channel_list):
            ...
            data = {"_id": 0, "video_id": 1, "channel_id": 1, "video_name": 1, "published_date": 1, "view_count": 1,
                    "like_count": 1, "comment_count": 1, "duration": 1}
        ...
        def get_comment_details(video_ids):
            ...
            projection = {"_id": 0, "comment_id": 1, "video_id": 1, "comment_text": 1, "comment_author": 1,
                          "comment_published_date": 1}
...
#  st.bar_chart(table7.set_index("Channel_name"))
    ...
    query9 = (
        "SELECT c.channel_name, TIME_FORMAT(SEC_TO_TIME(AVG(TIME_TO_SEC(TIME(Duration)))), '%H:%i:%s') AS duration FROM channel_data c JOIN video_data v ON c.channel_id = v.channel_id GROUP BY c.channel_name ORDER BY duration DESC;")
